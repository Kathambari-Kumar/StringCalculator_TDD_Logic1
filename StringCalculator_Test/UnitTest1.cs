...
namespace StringCalculator_Test
{
    ...
    {
        String_Calc strcalc = new String_Calc();

        [TestMethod]
        public void Add_CheckStrEmpty_ReturnsZero()
        {
            Assert.AreEqual(0, strcalc.Add(""));
        }

        [TestMethod]
        public void Add_CheckStrOne_ReturnsSum()
        {
            Assert.AreEqual(10, strcalc.Add("10"));
        }

        [TestMethod]
        public void Add_CheckStrTwo_ReturnsSum()
        {
            Assert.AreEqual(42, strcalc.Add("17,25"));
        }
